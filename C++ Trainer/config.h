...
#define PERSIAN_PROCESS_EPOCHS 12
#define PERSIAN_STARTING_LEARNING_RATE 0.5
#define PERSIAN_ENDING_LEARNING_RATE 0.01
...
#define CHECKPOINT_NTH_SAMPLE 2000 // Will save the neural network's paramters to a file every nth sample
...
#define ENGLISH_DATASET_RANDOM_TRANSFORMATION false
