...
void readPersianDataset(double*** pixelsDataArr, int** labelsArr, int* count)
{
	...
	// Test data seems to contain corrupted data. Number 4 is set as answer when it is not.
	// And at points has overflowing integers as answer.

	readHoda(DATASETS_PATH "/Train 60000.cdb", pixelsDataArr, labelsArr, count);

	// Uncomment and use this block to merge train and test hoda dataset.
	/*
